...
<div id="alertJsp"
     ...
     align="center">
    <div class="alert_title" onmousedown="mouseDownFun('alert')"><span class="alert_header" id="a_title"></span><span
            id="a_close" class="alert_close" onclick="closeDiv('alert')" title="关闭"></span></div>
    <div class="alert_content">
        <span class="dialog_icon" id="dialog_icon"></span>
        <div id="aTitle"></div>
    </div>
    <div class="alert_operate">
        　<input id="alert_update" class="btn_22" flag="done" type="button" onclick="comu_done();" value="确定"/>
