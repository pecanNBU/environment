...
public interface HCNetSDK extends StdCallLibrary {
    ...
    // String url=  getServletContext().getRealPath("/WEB-INF/")+"/lib/HCNetSDK";
...
//2007-11-30 V211支持以下接口 //11
    ...
    interface FMSGCallBack extends StdCallCallback {
        void invoke(NativeLong lCommand, NET_DVR_ALARMER pAlarmer, RECV_ALARM pAlarmInfo, int dwBufLen, Pointer pUser);
    }
...
*/
    ...
    */
    ...
    class NET_DVR_EMAILCFG extends Structure {	/* 12 bytes */
        public int dwSize;
